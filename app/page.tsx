      ...
      <main className="max-w-5xl mx-auto p-6 font-sans">
        ...
        <header className="flex justify-between items-center mb-12 py-6 border-b border-slate-100 dark:border-gray-800">
          ...
          <div className="flex items-center gap-2 md:gap-4 lg:gap-6">
            {userNickname ? (
              <>
                {/* ДЕСКТОПНЫЕ ФИЛЬТРЫ (скрыты на мобильных) */}
                ...
                {/* ПРОФИЛЬ (отображается и на мобильных, и на десктопе) */}
                <Link 
                  href="/profile" 
        ...
        <div className="max-w-md mx-auto">
          <div className="flex justify-around items-center bg-white/95 dark:bg-[#0A0A0A]/95 backdrop-blur-sm rounded-2xl border border-slate-200 dark:border-gray-800 p-3 shadow-lg">
            ...
            <Link 
              ...
              title="Новые главы за последние 24 часа"
            >
              <svg 
                className="w-5 h-5" 
                fill="none" 
                ...
                strokeWidth="2"
              >
                <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.715L18 9.75l-.259-1.035a3.375 3.375 0 00-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 002.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 002.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 00-2.456 2.456zM16.5 20.25l-1.5 1.5 1.5 1.5M19.5 18.75l-1.5 1.5 1.5 1.5" />
              </svg>
            </Link>
